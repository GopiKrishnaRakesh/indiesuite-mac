...
first_30_apps = [
    {
        ...
        "brew": "brew install --cask whispertap", "dmg": "downloads/whispertap-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "02-tokenwatch", "name": "TokenWatch", "cat": "ai", "catName": "AI & Dev", "icon": "💳",
        ...
        "brew": "brew install --cask tokenwatch", "dmg": "downloads/tokenwatch-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "03-locallens-ocr", "name": "LocalLens OCR", "cat": "ai", "catName": "AI & Vision", "icon": "🔍",
        ...
        "brew": "brew install --cask locallens-ocr", "dmg": "downloads/locallens-ocr-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "04-portsentry", "name": "PortSentry", "cat": "dev", "catName": "Developer", "icon": "🌐",
        ...
        "brew": "brew install --cask portsentry", "dmg": "downloads/portsentry-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "05-shrinkmedia", "name": "ShrinkMedia", "cat": "media", "catName": "Creative & Design", "icon": "🗜️",
        ...
        "brew": "brew install --cask shrinkmedia", "dmg": "downloads/shrinkmedia-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "06-colorforge", "name": "ColorForge", "cat": "media", "catName": "Creative & Design", "icon": "🎨",
        ...
        "brew": "brew install --cask colorforge", "dmg": "downloads/colorforge-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "07-notchshelf", "name": "NotchShelf", "cat": "system", "catName": "Utilities & System", "icon": "📥",
        ...
        "brew": "brew install --cask notchshelf", "dmg": "downloads/notchshelf-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "08-audiomix", "name": "AudioMix", "cat": "system", "catName": "Utilities & System", "icon": "🎚️",
        ...
        "brew": "brew install --cask audiomix", "dmg": "downloads/audiomix-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "09-micmute-hud", "name": "MicMute HUD", "cat": "system", "catName": "Utilities & System", "icon": "🔇",
        ...
        "brew": "brew install --cask micmute-hud", "dmg": "downloads/micmute-hud-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "10-promptdock", "name": "PromptDock", "cat": "ai", "catName": "AI & Voice", "icon": "✨",
        ...
        "brew": "brew install --cask promptdock", "dmg": "downloads/promptdock-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "11-snaptile", "name": "SnapTile", "cat": "focus", "catName": "Focus & Flow", "icon": "🪟",
        ...
        "brew": "brew install --cask snaptile", "dmg": "downloads/snaptile-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "12-purgeapp", "name": "PurgeApp", "cat": "system", "catName": "Utilities & System", "icon": "🗑️",
        ...
        "brew": "brew install --cask purgeapp", "dmg": "downloads/purgeapp-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "13-chargeguard", "name": "ChargeGuard", "cat": "routine", "catName": "Routine & Wellness", "icon": "🔋",
        ...
        "brew": "brew install --cask chargeguard", "dmg": "downloads/chargeguard-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "14-envvault", "name": "EnvVault", "cat": "dev", "catName": "Developer", "icon": "🔐",
        ...
        "brew": "brew install --cask envvault", "dmg": "downloads/envvault-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "15-devtunnel-hud", "name": "DevTunnel HUD", "cat": "dev", "catName": "Developer", "icon": "🚇",
        ...
        "brew": "brew install --cask devtunnel-hud", "dmg": "downloads/devtunnel-hud-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "16-gitpulse", "name": "GitPulse", "cat": "dev", "catName": "Developer", "icon": "🌿",
        ...
        "brew": "brew install --cask gitpulse", "dmg": "downloads/gitpulse-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "17-regexforge", "name": "RegexForge", "cat": "dev", "catName": "Developer", "icon": "🔣",
        ...
        "brew": "brew install --cask regexforge", "dmg": "downloads/regexforge-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "18-svgoptim", "name": "SVGOptim", "cat": "media", "catName": "Creative & Design", "icon": "📐",
        ...
        "brew": "brew install --cask svgoptim", "dmg": "downloads/svgoptim-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "19-fontinspect", "name": "FontInspect", "cat": "media", "catName": "Creative & Design", "icon": "🔤",
        ...
        "brew": "brew install --cask fontinspect", "dmg": "downloads/fontinspect-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "20-presentercam", "name": "PresenterCam", "cat": "social", "catName": "Social & Creator", "icon": "📷",
        ...
        "brew": "brew install --cask presentercam", "dmg": "downloads/presentercam-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "21-cleandesk-pro", "name": "CleanDesk Pro", "cat": "focus", "catName": "Focus & Flow", "icon": "✨",
        ...
        "brew": "brew install --cask cleandesk-pro", "dmg": "downloads/cleandesk-pro-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "22-screenruler", "name": "ScreenRuler", "cat": "media", "catName": "Creative & Design", "icon": "📏",
        ...
        "brew": "brew install --cask screenruler", "dmg": "downloads/screenruler-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "23-apphop", "name": "AppHop", "cat": "focus", "catName": "Focus & Flow", "icon": "⚡️",
        ...
        "brew": "brew install --cask apphop", "dmg": "downloads/apphop-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "24-scratchpad-hud", "name": "ScratchPad HUD", "cat": "focus", "catName": "Focus & Flow", "icon": "📝",
        ...
        "brew": "brew install --cask scratchpad-hud", "dmg": "downloads/scratchpad-hud-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "25-timebridge", "name": "TimeBridge", "cat": "routine", "catName": "Routine & Wellness", "icon": "🕒",
        ...
        "brew": "brew install --cask timebridge", "dmg": "downloads/timebridge-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "26-menucleaner", "name": "MenuCleaner", "cat": "system", "catName": "Utilities & System", "icon": "🍱",
        ...
        "brew": "brew install --cask menucleaner", "dmg": "downloads/menucleaner-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "27-metascrub", "name": "MetaScrub", "cat": "system", "catName": "Utilities & System", "icon": "🛡️",
        ...
        "brew": "brew install --cask metascrub", "dmg": "downloads/metascrub-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "28-bandwidthradar", "name": "BandwidthRadar", "cat": "system", "catName": "Utilities & System", "icon": "📡",
        ...
        "brew": "brew install --cask bandwidthradar", "dmg": "downloads/bandwidthradar-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "29-bluetoothautohop", "name": "BluetoothAutoHop", "cat": "system", "catName": "Utilities & System", "icon": "🎧",
        ...
        "brew": "brew install --cask bluetoothautohop", "dmg": "downloads/bluetoothautohop-1.0.0.dmg", "price": "$9"
    },
    {
        "id": "30-privatellm-bar", "name": "PrivateLLM Bar", "cat": "ai", "catName": "AI & Voice", "icon": "🧠",
        ...
        "brew": "brew install --cask privatellm-bar", "dmg": "downloads/privatellm-bar-1.0.0.dmg", "price": "$9"
    }
]
...
for app in new_50_apps:
    formatted_new_50.append({
        ...
        "icon": app["title"].split("(")[0].strip() if "(" in app["title"] else "⚡️",
        "hotkey": app["hotkey"],
        "desc": app["desc"],
